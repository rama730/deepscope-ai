...
export function ProfileHeader({
  ...
  onConnectSecondary?: () => void; // e.g., decline incoming
  onMessage: () => void;
  onInvite: () => void;
  isAdaptive?: boolean;
      ...
      <div className="px-5 sm:px-8 py-6">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-4">
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl overflow-hidden border border-zinc-200 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-900 flex-shrink-0">
              {avatarSrc && !isAdaptive ? (
                ...
                // Adaptive: Render simplified Image
