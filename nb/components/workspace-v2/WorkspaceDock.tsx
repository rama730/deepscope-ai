  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        // Strict fixed widths with transform instead of width transition for better performance
        isExpanded ? "w-[500px]" : "w-[60px]"
      )}
      style={{
        // Use visibility to remove from accessibility tree when closed but keep mounted
        visibility: isOpen ? "visible" : "hidden", 
        // Ensure strictly active only when open to prevent interfering with clicks
    ...
    >
              ...
              <button
                ...
                className={cn(
                  ...
                  isActive 
                    ...
                    : "text-zinc-400 hover:text-zinc-600 dark:text-zinc-400 dark:hover:text-zinc-300 hover:bg-zinc-100 dark:bg-zinc-900 dark:hover:bg-zinc-800"
                )}
      ...
      {/* Expanded Content Area - Strict Layout */}
      {/* We keep this mounted but use opacity to hide content when collapsed for performance */}
      <div className={cn(
