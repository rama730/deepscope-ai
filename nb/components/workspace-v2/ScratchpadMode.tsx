...
function ScratchpadMode() {
  ...
  const handleConvertToTask = () => {
    // Logic to convert selected text or full content to task
    alert("Converted to task: " + content.slice(0, 50) + "...");
  };
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-1">
          <button 
            ...
            className="p-1.5 text-zinc-400 hover:text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:bg-zinc-900 dark:hover:bg-zinc-800 rounded-lg transition-colors"
