-- Migration: Add thread_root_id to get_explorer_feed RPC
-- Purpose: Allow the frontend to group replies (including reply-to-reply) under the correct host/root post,
--          even when only 1-level parent context is available.
